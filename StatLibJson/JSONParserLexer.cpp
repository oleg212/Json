...
struct JSONParserLexerStaticData final {
  JSONParserLexerStaticData(std::vector<std::string> ruleNames,
  ...
  JSONParserLexerStaticData(const JSONParserLexerStaticData&) = delete;
  JSONParserLexerStaticData(JSONParserLexerStaticData&&) = delete;
  JSONParserLexerStaticData& operator=(const JSONParserLexerStaticData&) = delete;
  JSONParserLexerStaticData& operator=(JSONParserLexerStaticData&&) = delete;
...
::antlr4::internal::OnceFlag jsonparserlexerLexerOnceFlag;
#if ANTLR4_USE_THREAD_LOCAL_CACHE
static thread_local
#endif
JSONParserLexerStaticData *jsonparserlexerLexerStaticData = nullptr;

void jsonparserlexerLexerInitialize() {
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  if (jsonparserlexerLexerStaticData != nullptr) {
    return;
  }
#else
  assert(jsonparserlexerLexerStaticData == nullptr);
#endif
  auto staticData = std::make_unique<JSONParserLexerStaticData>(
  ...
  jsonparserlexerLexerStaticData = staticData.release();
}

}

JSONParserLexer::JSONParserLexer(CharStream *input) : Lexer(input) {
  JSONParserLexer::initialize();
  _interpreter = new atn::LexerATNSimulator(this, *jsonparserlexerLexerStaticData->atn, jsonparserlexerLexerStaticData->decisionToDFA, jsonparserlexerLexerStaticData->sharedContextCache);
}

JSONParserLexer::~JSONParserLexer() {
  delete _interpreter;
}

std::string JSONParserLexer::getGrammarFileName() const {
  return "JSON.g4";
}

const std::vector<std::string>& JSONParserLexer::getRuleNames() const {
  return jsonparserlexerLexerStaticData->ruleNames;
}

const std::vector<std::string>& JSONParserLexer::getChannelNames() const {
  return jsonparserlexerLexerStaticData->channelNames;
}

const std::vector<std::string>& JSONParserLexer::getModeNames() const {
  return jsonparserlexerLexerStaticData->modeNames;
}

const dfa::Vocabulary& JSONParserLexer::getVocabulary() const {
  return jsonparserlexerLexerStaticData->vocabulary;
}

antlr4::atn::SerializedATNView JSONParserLexer::getSerializedATN() const {
  return jsonparserlexerLexerStaticData->serializedATN;
}

const atn::ATN& JSONParserLexer::getATN() const {
  return *jsonparserlexerLexerStaticData->atn;
}




void JSONParserLexer::initialize() {
#if ANTLR4_USE_THREAD_LOCAL_CACHE
  jsonparserlexerLexerInitialize();
#else
  ::antlr4::internal::call_once(jsonparserlexerLexerOnceFlag, jsonparserlexerLexerInitialize);
#endif
}
